        ...
        <div class="w-[calc(100%-483px)] h-100%">
          <form id="bootstrapForm">
            ...
            <div class="mb-3">
              <div class="row">
                <div class="col">
                  ...
                  <input type="text" class="form-control" v-model="paymentStore.firstname" id="formFirstNameInput" placeholder="First name" aria-label="First name">
                </div>

                <div class="col">
                  <div class="form-label">Last Name</div>
                  <input type="text" class="form-control" v-model="paymentStore.lastname" id="formLastNameInput" placeholder="Last name" aria-label="Last name">
                </div>
              </div>
            </div>
            <!-- address -->
            <div class="mb-3">
              ...
              <input type="text" class="form-control" v-model="paymentStore.address" id="formAddressInput" placeholder="3700 Noxus">
            </div>
            <!-- city&postal -->
            <div class="mb-3">
              <div class="row">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" v-model="paymentStore.email" id="formEmailInput" placeholder="Yasuo@example.com">
            </div>
            <!-- phone number -->
            <div class="mb-3">
              <label for="formPhoneInput" class="form-label">Phone Number</label>
              <input type="text" class="form-control" v-model="paymentStore.phonenumber" id="formPhoneInput" placeholder="+855 (168) 000-0000">
            </div>
            <!-- check box -->
        ...
        <div class=" w-[483px] h-100% flex flex-col justify-center pl-[40px] gap-[30px] ">
          ...
          <form class="flex items-center">
            <div class="flex flex-col">
              ...
              <div class="flex items-center justify-center gap-3">
                <input v-model="paymentStore.coupon" placeholder="COUPON" style="font-family: 'SF-Pro', sans-serif;" type="text" class="form-control text-[24px] w-[300px] h-[70px]" aria-describedby="emailHelp">
                <div @click="checkCoupon(paymentStore.coupon)" class=" mb-[10px] bg-white text-black border-black border-[1px] rounded-[10px] w-[90px] h-[70px] mt-[20px] flex justify-center items-center">Apply</div>
              </div>
          ...
          <div>
            <div class="form-check">
              <input class="form-check-input" type="radio" v-model="selectedPaymentMethod" value="flexRadioCreditCard" name="flexRadioPayment" id="flexRadioCreditCard">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" v-model="selectedPaymentMethod" value="flexRadioCashOnDelivery" name="flexRadioPayment" id="flexRadioCashOnDelivery" checked>
          ...
          <div class="flex flex-col gap-[20px] justify-center items-center">
            <!-- forwardBtn -->
            <forwardBtnCart class="btnText" to="/payment" btnText="Continue to Payment" width="350px" height="70px" gap="15px" padleft="15px" padright="15px"></forwardBtnCart>
            <!-- backBtn -->
            <backBtnCart class="btnText" btnText="Back To Cart" gap="8px" to="/"></backBtnCart>
          </div>
