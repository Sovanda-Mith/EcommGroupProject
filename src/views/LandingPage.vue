<template>
  <div class="bg-[#cbd7d1] flex flex-col w-full">
    <!-- Header -->
    ...
    <!-- Big Panel -->
    <div class="flex items-center bg-black pt-32">
      <img
      ...
      <img
        src="../assets/landPageImg/alt-arrow-right-svgrepo-com.svg"
        alt="right icon"
        class="w-[50px] h-[50px]"
        @click="handlePanelChange"
      />
