...
<template>
  <div class="flex flex-col w-100% h-100%">
    <PromotionBar/>
    <NavBar/>
    <div class="paymentPage w-100% h-[1024px] bg-[#A1A1A1] flex flex-col justify-center items-center" id="paymentPage">
      <div class="relative cartContainer w-[1292.2px] h-[810px] rounded-[50px] bg-white">
        ...
        <div class="form-coupon flex p-[20px] h-[calc(100%-140px)] rounded-b-[50px]" style="font-family: 'SF-Pro', sans-serif; font-weight: 300;">
          <!-- form payment -->
                  ...
                  <div class="mb-3 flex flex-col gap-[30px]">
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <input type="text" v-model="paymentStore.nameCard" class="form-control w-[350px]" placeholder="Name" aria-label="First name">
                      </div>
                      <div class="col">
                        <div class="form-label">Expiration Date</div>
                        <input type="text" v-model="paymentStore.expDateCard" class="form-control" placeholder="08/2025" aria-label="Last name">
                      </div>
                    </div>
                    <!-- cardNum -->
                    <div class="row">
                      <div class="col">
                        ...
                        <input type="text" v-model="paymentStore.numberCard" class="form-control w-[350px]" placeholder="0000-0000-0000" aria-label="First name">
                      </div>
                      <div class="col">
                        <div class="form-label">CSV</div>
                        <input type="text" v-model="paymentStore.csvCard" class="form-control" placeholder="XXX" aria-label="Last name">
                      </div>
                    </div>
                  </div>
                </form>
          ...
          <div class="method-section w-[483px] h-100% flex flex-col justify-start pl-[40px] gap-[30px] ">
            ...
            <form class="flex items-center">
              ...
              <div class="flex flex-col">
                ...
                <div class="flex items-center justify-center gap-3">
                  <input placeholder="COUPON" v-model="paymentStore.getCoupon" style="font-family: 'SF-Pro', sans-serif;" type="email" class="form-control text-[24px] w-[300px] h-[70px]" id="exampleInputEmail1" aria-describedby="emailHelp">
                  <div class=" mb-[10px] bg-white text-black border-black border-[1px] rounded-[10px] w-[90px] h-[70px] mt-[20px] flex justify-center items-center">Applied</div>
                </div>
            ...
            <div class="flex flex-col gap-[20px] justify-center items-center">
              <!-- forwardBtn -->
              <forwardBtnCart @click="showPopup()" class="btnText" btnText="Continue to Payment" width="350px" height="70px" gap="15px" padleft="15px" padright="15px"></forwardBtnCart>
              <!-- backBtn -->
              <backBtnCart class="btnText" btnText="Back" gap="8px" to="/checkout"></backBtnCart>
            </div>
  ...
  <div id="popup" class="popup bg-white w-[900px] h-[600px] gap-4 border-solid border-[1px] border-black rounded-[30px] flex flex-col justify-center items-center" style="font-family: 'SF-Pro', sans-serif; font-weight: 300;">
    ...
    <button id="closePopup" class="w-[200px] h-[80px] border-solid border-[1px] border-black rounded-[30px] font-bold text-[28px]" @click="hidePopup()" >Okay, Got it</button>
  </div>
